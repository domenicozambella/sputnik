...
\bigskip
These notes are a digested read of (a fraction of) \href{http://www.math.ucla.edu/~chernikov/teaching/Combinatorics285N/CombinatoricsNotes.pdf}{Artem Chernicov's Topics in combinatorics}.

These notes are intended to support the students of my course in Turin, fall 2017 (some proofs are different from Chernikov's). However, they are less complete and less reliable than Chernicov's notes which I recommend as the main source. 
\subfile{sauer}
\subfile{samples}
\subfile{helly}
%\subfile{pearcing}
