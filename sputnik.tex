...
These notes are intended to support the students in Turin, fall 2017 (some proofs are different from Chernikov's). However, they are less complete and less reliable than Chernicov's notes which I recommend as the main source. 
\subfile{sauer}
\subfile{samples}
\subfile{helly}
%\subfile{pearcing}
