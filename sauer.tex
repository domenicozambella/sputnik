...
\ceq{\hfill|\phi(A,b)_{b\in\V}|}{\le}{\#\{C\subseteq A\; :\; C \textrm{\ is\ shattered\ by\ }\phi\}}.
\end{proposition}

We show how Sauer-Shelah's Lemma follows from Pajor's Lemma. If $\phi$ has \vc-dimension $k$ then

\ceq{\hfill\{C\subseteq A\; :\; C\textrm{\ shattered\ by\ }\phi\}}{\subseteq}{\bigcup^k_{i=0}{A\choose i}}.

Then by  Pajor's Lemma

\ceq{\hfill\pi_\phi(n)\medrel{=}|\phi(A,b)_{b\in\V}|}{\le}{\left|\bigcup^k_{i=0}{A\choose i}\right|\medrel{=}\sum^k_{i=0} \binom{n}{i}.}
