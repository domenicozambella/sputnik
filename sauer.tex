...
%We assume $\phi$ is neither of the form $U\times B$ nor $A\times V$ for some $A\subseteq U$ and $B\subseteq V$.
%This is a non standard assumption which we make to avoid trivialities.
...
\ceq{\hfill\emph{$\pi^*_\phi(n)$}}{=}{\max\Big\{|\phi(a,B)_{a\in U}|\ \ :\ \ B\subseteq V,\ |B|=n\Big\}.}
