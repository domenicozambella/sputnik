...
For any $d,\epsilon>0$, every measure on a set system $\Phi$ of \vc-density $\le d$, has an $\epsilon$-net of cardinality $\displaystyle\le c\,\frac d\epsilon\,\ln \frac1\epsilon$ where $c$ is an absolute constant.
\end{proposition}
