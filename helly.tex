...
\smallskip
\textit{Claim 1.}
For some $\alpha=\alpha(p,q)>0$ there are \smash{$\displaystyle\alpha{n\choose q}$} many collections in \smash{$\displaystyle{\Phi\choose q}$} with non-empty intersection.
...
\ceq{\hfill\frac{\displaystyle{n\choose p}}{\displaystyle{n-q\choose p-q}}}{=}{{p\choose q}^{-1}{n\choose q}}

$q$-collections of definable sets with non-empty intersection, which yields \smash{$\displaystyle\alpha={p\choose q}^{-1}$} and proves the claim.
